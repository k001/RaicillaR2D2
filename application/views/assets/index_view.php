...
<title>Login :: Raicilla R2D2</title>
							...
							<div class="inner">
								<div class="contents">
									<div class="one-half username-half">
										...
										<div class="field-box"><span class="icon awesome user for-input"></span><input id="username" type="text" class="w-icon validate[required]"></div>
										<div class="clear"></div>
									</div>
									<div class="one-half password-half">
										<label><?=lang('admin_password')?></label>
										<div class="field-box"><span class="icon awesome lock for-input"></span><input  id="password" type="password" class="w-icon validate[required]"></div>
										<div class="clear"></div>
									</div>								
									<div class="clear"></div>
									<div class="line-separator"></div>
									<div class="one-half">
										<a href="#"><?=lang('admin_forgot')?> ?</a>
									</div>
									<div class="one-half right">
										<input type="submit" value="<?=lang('admin_login')?>" class="button blue tiny">
									</div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>
